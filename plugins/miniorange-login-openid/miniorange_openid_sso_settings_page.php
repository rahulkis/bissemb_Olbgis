                                ...
                                <tr>
                                    <td><div>
                                        <a id="addon" class="mo_sl_header_text mo_sl_effect-shine mo_sl_expand" style="color: white; text-decoration: none; " <?php echo $active_tab == 'add_on' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'add_on'), $_SERVER['REQUEST_URI'] ); ?>"><?php echo mo_sl('Add On');?></a>
                                            ...
                                            &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<b><a id="rest_api_page" class="mo_sl_header_text mo_sl_effect-shining mo_sl_expand" target="_blank" style="color: white; text-decoration: none; "<?php echo $active_tab == 'rest_api_page' ? 'nav-tab-active' : ''; ?>" href="https://plugins.miniorange.com/wordpress-rest-api-authentication"><?php echo mo_sl("Rest API");?></a></b>
