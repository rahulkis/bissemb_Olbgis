...
class Simba_Two_Factor_Authentication {
	...
	public function __construct() {
		...
		if (file_exists(__DIR__.'/premium/loader.php')) {
			if (!class_exists('Simba_Two_Factor_Authentication_Premium')) include_once(__DIR__.'/premium/loader.php');
			$GLOBALS['simba_two_factor_authentication_premium'] = new Simba_Two_Factor_Authentication_Premium($this);
		}
