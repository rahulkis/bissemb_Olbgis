...
?><div class="wrap">
	...
	if (function_exists('WC')) {
		...
		<p>
			<?php echo apply_filters('simba_tfa_settings_woocommerce', '<a href="https://www.simbahosting.co.uk/s3/product/two-factor-authentication/">'.__('The Premium version of this plugin allows you to add a configuration tab for users in the WooCommerce "My account" area, and anti-bot protection on the WooCommerce login form.', 'two-factor-authentication').'</a>'); ?>
		</p>
		<hr>
	<?php } ?>
