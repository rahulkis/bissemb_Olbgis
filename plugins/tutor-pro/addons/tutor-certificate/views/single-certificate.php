...
<div class="tutor-download-certificate tutor-pb-48 tutor-p-12">
    ...
    <div class="tutor-dc-button-group tutor-mt-72">
        <div class="tutor-dc-download-button tutor-py-16">
            <button class="tutor-iconic-btn tutor-iconic-btn-outline tutor-iconic-btn-lg tooltip-wrap tutor-download-btn-new">
                ...
                <br><br>
                <div class="loader1"><img src="<?php echo TUTOR_CERT()->url . 'assets/images/loader.gif'; ?>" style="width30px; height:30px"></div>
            </button>
...
<style>.loader1{ display:none;}</style>
<script>
jQuery( document ).ready(function() {
   jQuery('.tutor-download-btn-new').click(function(){
       jQuery('.loader1').css('display','block').delay(20000).hide("slow");
   });
