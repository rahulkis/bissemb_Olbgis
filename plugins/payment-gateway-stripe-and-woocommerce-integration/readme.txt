...
Enables Stripe checkout in your WooCommerce store. Accepts payments from Credit Cards, Debit Cards, Google Pay, Apple Pay, Alipay, SEPA, Klarna, WeChat Pay, Sofort, iDEAL, BECS, Bacs, Boleto, OXXO, Multibanco, Bancontact, P24, giropay, and Afterpay/Clearpay using Stripe.
...
* Fix] - Prevent duplicate order not generated from WebHook response
