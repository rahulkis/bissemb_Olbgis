 ...
 * Description: Accept payments from your WooCommerce store via Credit/Debit Cards, Stripe Checkout, Apple Pay, Google Pay, Alipay, SEPA Pay, Klarna, Afterpay, WeChat Pay, Sofort, iDEAL, Bancontact, EPS, P24, Giropay, Bacs Debit, BECS Debit, FPX, Boleto, OXXO, GrabPay and Multibanco using Stripe.
 * Author: WebToffee
...
if (!defined('EH_STRIPE_VERSION')) {
    define('EH_STRIPE_VERSION', '3.7.3');
}
